...
<body>
  ...
  <div class="container">
	...
	<div id="carousel-example-generic" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="item active">
				<img src="img/apt1.jpg" alt="First slide" style="margin: auto;"
			...
			<div class="item">
				<img src="img/apt4.jpg" alt="Fourth slide" style="margin: auto;"
					width=400 height=400>
			</div>
		</div>
	...
	<div>
		<table align="center" class="center-block" cellpadding="80"
			cellspacing="100">
			<tr>
				<td>
	...
	<div>
		<table align="center" class="center-block" cellpadding="80"
			cellspacing="100">
			<tr>
				<td><img src="img/apt.gif" alt="zezeze" class="img-rounded"
					width=150 height=150> <br></br>
					<p>
						<span>Find Whole Apartment/House</span>
					</p>
					<p>
						<button type="button" class="btn btn-primary btn-lg"
							onClick="wholeapt()">View Postings</button>
					</p></td>
				<td><img src="img/share.jpg" alt="zezeze" class="img-rounded"
					width=150 height=150> <br></br>
					<p>
						<span>Find Whole Apartment/House</span>
					</p>
					<p>
						<button type="button" class="btn btn-primary btn-lg"
							onClick="shareapt()">View Postings</button>
					</p></td>
				<td><img src="img/sublet.jpg" alt="zezeze" class="img-rounded"
					width=150 height=150> <br></br>
					<p>
						<span>Find Whole Apartment/House</span>
					</p>
					<p>
						<button type="button" class="btn btn-primary btn-lg"
							onClick="subletapt()">View Postings</button>
					</p></td>
